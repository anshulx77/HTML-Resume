# HTML Resume Project
[![HTML5](https://img.shields.io/badge/HTML5-orange?style=flat)](https://developer.mozilla.org/en-US/docs/Web/HTML)
[![Font](https://img.shields.io/badge/Font-Cascadia_Code-blue?style=flat)](https://fonts.google.com/specimen/Cascadia+Code)
...
- `<p>`, `<strong>`, `<br>`, `<hr>`: For text flow, emphasis, and section separation.
- `<a>`, `<img>`: For contact links and profile picture integration.
- `<footer>`, `<center>`: For the copyright notice and final alignment.
